...
public class MigronitorDataSource {
    ...
    public List<Attacke> getLastAttacken() {
        List<Attacke> se = new ArrayList<Attacke>();
        Cursor cursor = database.query(true, MigronitorDbHelper.TABLE_ATTACKEN,
                allColumnsAttacken, null, null, null, null, MigronitorDbHelper.COLUMN_ATTACKEN_DATESTART + " DESC", "30");
