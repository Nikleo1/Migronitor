 ...
 */
public class AttackenBearbeitenListAdapter extends ArrayAdapter<Medikament> {

        private List<Medikament> items;
        private int layoutResourceId;
        private Context context;

        public AttackenBearbeitenListAdapter(Context context, int layoutResourceId, List<Medikament> items) {
